...
const CreatePost = () => {
  ...
  const { loading, submitPost } = usePosts();
  const { generatingImg, submitPrompt } = useOpenAi();
  ...
  const generateImg = async () => {
    if (form.prompt) {
      const data = await submitPrompt(form.prompt);
  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={hanldeSumbit}>
